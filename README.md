# Codex Field Guide — 102 Use Cases | TH / EN

Web presentation สองภาษา ไทย/อังกฤษ ที่สรุป use case ทั้งหมด 102 รายการจาก [OpenAI Learn: Use cases](https://learn.chatgpt.com/use-cases) ณ วันที่ 31 สิงหาคม 2026 แต่ละ use case มีสไลด์เฉพาะ พร้อม workflow 4 ขั้น, Prompt เริ่มต้น, Human checkpoint และลิงก์กลับไปยัง official source
...
- `data/usecases-data.js` — ข้อมูล 102 use-case slides ที่ build แล้ว
...
- `assets/use-cases/` — ภาพประกอบจากหน้า official use cases จำนวน 102 ภาพ
...
ตัว scraper ตั้งใจตรวจว่าหน้า official ยังมี 102 use cases หากจำนวนเปลี่ยนจะหยุดและแจ้งให้ทบทวนเนื้อหาไทยก่อน build ใหม่
